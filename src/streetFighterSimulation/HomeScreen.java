...
public class HomeScreen extends World {
	...
	private static final int DISTANCE_FROM_TOP_OF_SCREEN = 200;
	...
	private void makeMenu() {
		...
		this.addObject(new MainMenuButton("Give UP",100), ScaleOfScreen.WIDTH.getNum()/2, DISTANCE_FROM_TOP_OF_SCREEN*3);
	}
